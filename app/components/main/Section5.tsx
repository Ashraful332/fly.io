            ...
            <div className="max-w-[1200px] mx-auto pb-36 ">
                <div className="flex justify-between">
                    <div>
                        ...
                        <button className="bg-gradient-to-tr from-white/20 to-[#8B5CF6] text-white py-2 px-7 border border-white/25 rounded-3xl ">Learn More</button>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div className="w-40 h-24 bg-blue-400 rounded-2xl border border-blue-200/55 flex flex-col items-center p-3 ">
